...
const PARES: Array<{
...
}> = [
  {
    ...
    coluna: "kind",
    // O recibo das extensões (0272, renumerada de 0271). Quatro cópias no TypeScript viraram uma; um kind
  ...
  },
  {
    ...
    // commit da migration 0236, que é a lição desta lista: todos os que
