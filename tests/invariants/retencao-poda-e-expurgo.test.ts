...
describe("append-only: por onde o expurgo pode passar, e por onde não pode", () => {
  it("NINGUÉM tem GRANT de DELETE/UPDATE/TRUNCATE em api_audit_log — nem service_role", () => {
    ...
    // ficava verde com ou sem o revoke de UPDATE/DELETE da migration 0267
    // (renumerada de 0258). Agora a tabela nasce com o que o Supabase dá, e o
    // caso reprova sem esse revoke. Medido tirando `update, delete` do bloco
    // da 0267: vermelho com o prelude novo, verde com o antigo.
    const linhas = sql(`
