 ...
 * `false` até a origem publicar o dado. A descrição, por outro lado, É
 * inferida do padrão do nome (`inferirCategoria`) — é texto de ajuda pra
 * tela, não um campo que gate funcionalidade, então errar a categoria não
 * quebra chamada nenhuma.
 *
