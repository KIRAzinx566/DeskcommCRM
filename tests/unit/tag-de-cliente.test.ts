 ...
 * 0269); quem filtra por ela é TypeScript. São dois literais em dois idiomas,
 ...
 */
const MIGRATION = join(process.cwd(), "supabase/migrations/20260915180000_0269_cliente_pela_agenda.sql");
...
describe("a etiqueta de cliente", () => {
  it("é a mesma no TypeScript e em TODA constante SQL, e elas são duas", () => {
    ...
    expect(capturas, "a migration 0269 declara a etiqueta só em constantes, todas iguais").toEqual([
      TAG_DE_CLIENTE,
      TAG_DE_CLIENTE,
    ]);
  });
