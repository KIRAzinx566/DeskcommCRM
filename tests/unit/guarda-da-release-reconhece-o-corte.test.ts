...
/**
 * O nome de autor que o ato 1 do release.yml grava no git — "deskcomm-release-bot",
 * sem colchetes, porque este fork escreve com um Personal Access Token e não
 * com o GitHub App do upstream (que se apresentaria como "deskcomm-release[bot]").
 * Literal, e por isso forjável: a guarda antiga procurava exatamente esta
 * string; a nova confere a identidade pelo PR de origem, e este valor só
 * povoa o autor sintético dos commits de teste abaixo.
 */
