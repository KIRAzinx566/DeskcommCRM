...
// Upstream usa um GitHub App (identidade "deskcomm-release[bot]"); este fork
// usa um Personal Access Token (release.yml, PR de sincronização com o
// upstream) — a identidade configurada nos passos de escrita é
// "deskcomm-release-bot", sem colchetes, e é essa que o guard confere.
