 ...
 *
 *   1. a RÉGUA — `awaiting_since` (migration 0312, renumerada de 0267) guarda o começo da espera e
 ...
 *
 * O que NÃO mede: o SQL da 0312 (renumerada de 0267). O `CASE` que mantém a coluna é plpgsql e exige
 ...
 * que a 0312 (renumerada de 0267) produz — se ele e o SQL divergirem, a divergência aparece como o
...
// (migration 0312, renumerada de 0267) — ver a nota acima sobre o alcance deste espelho.
// ---------------------------------------------------------------------------
...
describe("a régua da espera é o começo dela, não o fim (migration 0312, renumerada de 0267)", () => {
...
/** A conversa como a 0312 (renumerada de 0267) a deixa depois do cenário: `awaiting_since` no começo. */
