 ...
 *   - a superfície imutável e o "roteiro só manual" existem na migration 0409
 *     (renumerada de 0394) e no apêndice, e o apêndice cria as funções ANTES da
 *     VARREDURA anon.
 */
...
const MIGRATION = readFileSync(
  join(process.cwd(), "supabase", "migrations", "20260923210000_0409_fluxos_de_atendimento_base.sql"),
  "utf8",
);
const REAPONTA =
