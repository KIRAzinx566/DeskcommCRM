...
function makeDb(opts: { sessions?: Linha[]; recusaColunaDoDesfecho?: boolean } = {}): Registro {
  ...
  class Q implements PromiseLike<unknown> {
    ...
    /** O banco SEM a migration 0381 (renumerada de 0311) recusa qualquer menção às colunas do desfecho. */
...
describe("registrarWebhookDaSessao — o desfecho gravado na sessão", () => {
  ...
  it("banco SEM a migration 0381 (renumerada de 0311): não lança e ainda devolve o desfecho para a resposta", async () => {
