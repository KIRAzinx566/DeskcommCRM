...
const REMOCOES_DELIBERADAS: Record<string, { valores: string[]; porque: string }> = {
  "20260918231000_0382_aviso_de_followup_sem_agente.sql::agent_inbox_items_kind_check": {
    ...
    porque:
      ...
      "e ficou parada; a 0382 (renumerada de 0312) reconstruiu a constraint a partir do estado que ENXERGAVA, " +
      "sem o valor da outra. Nenhum dos dois lados errou — na `main` sozinha a 0382 não " +
      ...
      "valores da 0382 mais o da 0292. O estado FINAL da cadeia tem o valor de volta, " +
