...
// `run-model-call.ts` desembrulha `RetryError` ao classificar a falha da IA de
// sempre (`RetryError.isInstance(err)`); sem o stub, o mock devolve `undefined`
// e o desembrulho lança antes do insert em `llm_calls`, perdendo a linha de erro.
vi.mock("ai", () => ({
