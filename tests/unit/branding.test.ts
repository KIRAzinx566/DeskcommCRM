 ...
 * (RFC 2606). `exemplo`/`ejemplo` NÃO entram aqui de propósito — `meu-gateway.exemplo.com`
...
const HOSTS_DECLARADOS: Record<string, EntradaDeHost> = {
  ...
  "integrate.api.nvidia.com": {
    categoria: "FORNECEDOR",
    motivo:
      "endpoint da API (compatível OpenAI) da NVIDIA — o código FALA com ele para sincronizar o catálogo de modelos e para as chamadas do provedor NVIDIA.",
  },
  "build.nvidia.com": {
    categoria: "FORNECEDOR",
    motivo: "console da NVIDIA onde o usuário gera a própria chave — endereço do fornecedor, citado na tela.",
  },
  "api-sandbox.asaas.com": {
    categoria: "FORNECEDOR",
    motivo: "endpoint sandbox da API do Asaas (billing) — o código FALA com ele nos ambientes de teste.",
  },
  "api.asaas.com": {
    categoria: "FORNECEDOR",
  ...
  "meu-gateway.exemplo.com": {
    categoria: "AMOSTRA",
    motivo:
      "placeholder do campo de base URL de gateway OpenAI-compatible (agente, credenciais e provedores): amostra do formato aceito.",
  },
