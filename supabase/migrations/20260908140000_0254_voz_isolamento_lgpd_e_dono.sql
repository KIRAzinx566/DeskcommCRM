-- 0254_voz_isolamento_lgpd_e_dono (renumerada de 0235 na sincronização com o upstream)
--
-- Forward-fix da 0252 (chamada de voz WaCalls). A 0252 não é editada: doutrina
