-- ============================================================================
-- 0312 (renumerada de 0267 na sincronização com o upstream) — A espera na Fila não recomeça a cada mensagem do cliente (issue #990).
--
-- ─── O defeito ──────────────────────────────────────────────────────────────
...
begin
 ...
 -- (issue #990, migration 0312, renumerada de 0267) volta ao `last_inbound_at` — "não há mensagem do
