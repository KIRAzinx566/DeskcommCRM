-- 0269 (renumerada de 0262 na sincronização com o upstream) — cliente pela agenda: quem tem horário marcado vira cliente, SE a organização ligar
--
...
comment on function public.fn_colunas_de_cliente_sao_do_sistema() is
  'Guarda de contacts (migration 0269, renumerada de 0262): sessão nenhuma grava first_service_at, client_recognized_at ou '
...
begin
  ...
  -- A TRAVA DA REGRA "CLIENTES PELA AGENDA" (migration 0269, renumerada de 0262), ANTES DE TODA
