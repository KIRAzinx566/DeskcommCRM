-- 0207 — UM AGENTE PODE INDEXAR MAIS DE UM MATERIAL
--
...
comment on index public.ai_kbv_version_por_fonte is
  'O número da versão conta POR MATERIAL (semântica da 0181). O índice antigo era por agente e impedia o segundo material do mesmo agente de indexar — migration 0207.';
