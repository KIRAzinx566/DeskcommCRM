...
# Uso:
#   bash comecar.sh
#   curl -fsSL https://raw.githubusercontent.com/kirazinx566/DeskcommCRM/main/hostgator-setup-kit/comecar.sh | bash
#
set -euo pipefail

REPO_URL="${REPO_URL:-https://github.com/kirazinx566/DeskcommCRM.git}"
