...
export const AUDIT_ACTIONS = [
  ...
  // O catálogo da loja. Preço de venda é dado que a equipe
  ...
  // Sistema de cobrança ASAAS — dinheiro real saindo do
  ...
  // As tarefas do CRM (migration 0236). Tarefa é combinado de trabalho entre
  ...
  // "Cliente pela agenda" ligada ou desligada (migration 0269, renumerada de 0262). Ligar reescreve
