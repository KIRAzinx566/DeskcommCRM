...
function instanciar(
  ...
  switch (provider) {
    ...
    // padrão com aviso — a tela ofereceria um provedor que estes workers
    // ignoram. SEM `.chat()`, mesma razão de providers.ts e agent.ts: DeepSeek
    // é o único destes que fala a Responses API direto.
    case "deepseek":
