...
const arquivo = readdirSync(pasta).find((nome) => /_0272_extensoes_declarativas\.sql$/.test(nome));
if (!arquivo) throw new Error("Migration 0272 das extensões não encontrada");
