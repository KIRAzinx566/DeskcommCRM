...
export const DICIONARIO: Traducoes = {
  ...
  "Catálogo grande de modelos open-weight (Llama, Mistral, Qwen, DeepSeek e outros) hospedados pela NVIDIA, com tier gratuito generoso — bom para testar sem custo antes de migrar para um provedor pago.": {
    es: "Catálogo grande de modelos open-weight (Llama, Mistral, Qwen, DeepSeek y otros) alojados por NVIDIA, con nivel gratuito generoso — bueno para probar sin costo antes de migrar a un proveedor pago.",
  },
  "Qualquer endpoint que fale a API da OpenAI e você mesmo escolheu — Groq, Together, Cerebras, um gateway próprio, um modelo rodando na sua máquina. O endereço é obrigatório aqui: não existe um padrão para apontar sozinho.": {
    es: "Cualquier endpoint que hable la API de OpenAI y que hayas elegido tú mismo — Groq, Together, Cerebras, un gateway propio, un modelo corriendo en tu máquina. La dirección es obligatoria aquí: no existe un valor predeterminado para apuntar solo.",
  },
  ...
  "Conectar MCP": { es: "Conectar MCP" },
  "Conecte Claude Desktop, Cursor ou outro cliente MCP ao seu CRM.": {
    es: "Conecta Claude Desktop, Cursor u otro cliente MCP a tu CRM.",
  },
  ...
  // Clientes pela agenda (migration 0269, renumerada de 0262): o interruptor em Tipos de agendamento e a porta no rodapé de Funis.
  ...
  // Seleção em lote no quadro (migration 0235). A frase perdeu o substantivo
  ...
  "Nenhum lead neste funil ainda.": { es: "Ningún lead en este embudo todavía." },
  ...
  "Crie um lead manualmente neste funil.": { es: "Crea un lead manualmente en este embudo." },
  ...
  // ── Cadastro com aprovação (migration 0387 (renumerada de 0383), recorte do PR #714) ──────────
  ...
  "CSAT": { es: "CSAT" },
  "Erro ao carregar CSAT.": { es: "Error al cargar CSAT." },
  "Nota média (30 dias)": { es: "Nota media (30 días)" },
  "Pesquisas enviadas": { es: "Encuestas enviadas" },
  "Taxa de resposta": { es: "Tasa de respuesta" },
  "Respostas recentes": { es: "Respuestas recientes" },
  "Nenhuma pesquisa respondida ainda nos últimos 30 dias.": {
    es: "Ninguna encuesta respondida todavía en los últimos 30 días.",
  },
  "Nota": { es: "Nota" },
  "Resposta": { es: "Respuesta" },
  "Pesquisa de satisfação (CSAT) pelo WhatsApp": {
    es: "Encuesta de satisfacción (CSAT) por WhatsApp",
  },
  "Ao fechar uma conversa, pergunta a nota de 1 a 5 na mesma conversa — sem link externo, sem e-mail.": {
    es: "Al cerrar una conversación, pregunta la nota de 1 a 5 en la misma conversación — sin enlace externo, sin correo electrónico.",
  },
  "Pergunta enviada": { es: "Pregunta enviada" },
  ...
  "Em atendimento agora": { es: "En atención ahora" },
  "no teto": { es: "en el tope" },
  "Previsão": { es: "Previsión" },
  "Erro ao carregar previsão.": { es: "Error al cargar la previsión." },
  "Total em aberto (bruto)": { es: "Total en abierto (bruto)" },
  "Previsão ponderada": { es: "Previsión ponderada" },
  "Só etapas com probabilidade de fechar configurada entram aqui.": {
    es: "Solo las etapas con probabilidad de cierre configurada entran aquí.",
  },
  "previsto": { es: "previsto" },
  "Bruto": { es: "Bruto" },
  "Ponderado": { es: "Ponderado" },
  "Sem estimativa": { es: "Sin estimación" },
  "Probabilidade de fechar": { es: "Probabilidad de cierre" },
  "% de probabilidade de fechar — entra na previsão ponderada do Kanban e das Métricas": {
    es: "% de probabilidad de cierre — entra en la previsión ponderada del Kanban y de las Métricas",
  },
  ...
  "Nenhuma tarefa pendente para este negócio.": { es: "Ninguna tarea pendiente para este negocio." },
  "atrasada": { es: "atrasada" },
  "Nova tarefa": { es: "Nueva tarea" },
  "O que fazer? Ex: Ligar confirmando o orçamento": { es: "¿Qué hacer? Ej: Llamar confirmando el presupuesto" },
  "Criar tarefa": { es: "Crear tarea" },
  "Não consegui salvar. Tente de novo.": { es: "No pude guardar. Inténtalo de nuevo." },
  "Não consegui criar a tarefa. Tente de novo.": { es: "No pude crear la tarea. Inténtalo de nuevo." },
  ...
  "Aparecem no dossiê do negócio. No follow-up, você escolhe em qual campo gravar a resposta. Arraste pela alça para reordenar.": { es: "Aparecen en el expediente del negocio. En el seguimiento, eliges en qué campo guardar la respuesta. Arrastra por el asa para reordenar." },
  "Arrastar campo": { es: "Arrastrar campo" },
  "Preview": { es: "Vista previa" },
  "Assim é que o atendente vê estes campos no dossiê do negócio. Preencha à vontade — nada aqui é salvo.": { es: "Así es como el agente ve estos campos en el expediente del negocio. Completa a tu gusto — nada aquí se guarda." },
  "Adicione um campo para ver o preview.": { es: "Agrega un campo para ver la vista previa." },
  ...
  "Deixe em branco para usar o endereço oficial do provedor. Use isto para apontar para um gateway compatível com a API da OpenAI — inclusive um modelo rodando na sua própria máquina.": {
    es: "Déjalo en blanco para usar la dirección oficial del provider. Usa esto para apuntar a un gateway compatible con la API de OpenAI — incluso un modelo corriendo en tu propia máquina.",
  },
  "Deixe em branco para usar o endereço oficial do provedor. Use isto para apontar para um gateway compatível com a API da OpenAI — inclusive um modelo rodando na sua própria máquina. Um endereço na rede do servidor só funciona se quem administra a instalação o tiver liberado em Administração › Destinos internos — e, mesmo liberado, ele não vale para o endereço que esta empresa escolhe aqui.": {
    es: "Déjalo en blanco para usar la dirección oficial del provider. Usa esto para apuntar a un gateway compatible con la API de OpenAI — incluso un modelo corriendo en tu propia máquina. Una dirección en la red del servidor solo funciona si quien administra la instalación la liberó en Administración › Destinos internos — y, incluso liberada, no vale para la dirección que esta empresa elige aquí.",
  },
  ...
  // ─── Moeda da organização (Configurações › Organização, migration 0234) ───
  //
  ...
  "A conta da ASAAS usada para gerar boleto, Pix e cobrança no cartão.": {
    es: "La cuenta de ASAAS usada para generar boleto, Pix y cobro con tarjeta.",
  },
  ...
  // "Validando…" não se repete aqui: já existe acima com o mesmo valor.
  ...
  // "Motivo do cancelamento" não se repete aqui: já existe acima (motivo de perda do lead).
  ...
  // "Nova tarefa" não se repete aqui: já existe acima com o mesmo valor.
