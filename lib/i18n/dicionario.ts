...
export const DICIONARIO: Traducoes = {
  ...
  "Adicionados ao set padrão. Cada funil pode ter seus próprios motivos.": {
    es: "Se agregan al conjunto predeterminado. Cada embudo puede tener sus propios motivos.",
  },
  ...
  "Apagar aresta": { es: "Eliminar arista" },
  "Apagar aresta (ou selecione-a no canvas e pressione Delete)": {
    es: "Eliminar arista (o selecciónala en el lienzo y presiona Delete)",
  },
  "Apagar nó": { es: "Eliminar nodo" },
  "Apagar nó (ou selecione-o no canvas e pressione Delete)": {
    es: "Eliminar nodo (o selecciónalo en el lienzo y presiona Delete)",
  },
