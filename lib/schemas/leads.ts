...
export const CANONICAL_LOST_REASONS = [
   ...
   * e é ele que `fn_attendant_metrics` NÃO conta como perda (migration 0311, renumerada de 0266).
...
export const bulkLeadActionSchema = z.discriminatedUnion("action", [
  z.object({
    ...
    // (`fn_mover_leads_em_lote`, migration 0235), porque N cards precisam de N
