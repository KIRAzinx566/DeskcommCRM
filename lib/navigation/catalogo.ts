...
export const NAV_CATALOG = [
  ...
  },
  {
    ...
    //
    // SEM `sidebar`: a lista de "uso diário" do CRM é EXATA (kanban, contatos,
    // tarefas) desde que Tarefas virou o quinto destino e estourou a dobra em
    // 900px — medido pelo e2e `navegacao.spec.ts`, que fez o grupo ganhar hub
    // no lugar de mais densidade raspada do `Sidebar.tsx`. Um sexto item no
    // sidebar reabriria a mesma corrida por pixel; mora atrás de "Ver tudo em
    // CRM", igual a Produtos e Etapas do funil.
  ...
  },
  {
    ...
    label: "Conectar MCP",
    description: "Conecte Claude Desktop, Cursor ou outro cliente MCP ao seu CRM.",
    icon: "Broadcast",
    group: "organizacao",
    section: "Dados e acesso",
    minRole: "admin",
